...
- [#146] Update base image to v3.24.1-1
- [#148] Upgrade warp-menu to v2.1.0
...
### Added
- [#121] configurable proxy buffer sizes in the dogu config
  - this config can be used if requests fail because of large headers
